...
if (process.env.NODE_ENV == "development") {
  ...
  // axios.defaults.baseURL = 'http://192.168.38.96:10134'
...
const urlBlack = ['https://ysclass.net/base-api/base/api/auth/loginByUserPwdNoOrg']
/**
 * post方法，对应post请求
 * @param {String} url [请求的url地址]
 * @param {Object} params [请求时携带的参数]
...
export function post(url, params) {
	let urlBlackItme = urlBlack.some(v => {
		return v == url
	})
	let params1 
	if(!urlBlackItme) {
